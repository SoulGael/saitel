...
$consulta="select id_factura_venta, txt_sucursal, numero_factura, fecha_emision, total, txt_estado_documento,clave_acceso
	...
	where id_cliente in (".$id.") and anulado=false and documento_xml is not null and documento_xml not in ('') and fecha_emision between '".$desde."' and '".$hasta."'
