...
and estado_documento='a' and rc.documento_xml is not null and rc.documento_xml not in ('') and rc.documento='l' and rc.anulado=false and rc.ret_fecha_emision between '".$desde."' and '".$hasta."'
